                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                          <div class="btn-group">
                                            {{-- <a href="{{route('admin.category.edit',Crypt::encrypt($category->id))}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a> --}}
                                            <a href="{{route('admin.category.delete',Crypt::encrypt($category->id))}}" class="btn btn-sm btn-danger" onclick="return conf()"><i class="fa fa-trash"></i></a>
                                          </div>
                                      </td>
                                    </tr>
                                    @empty
