                        ...
                        <table class="table card-table table-vcenter">
                            ...
                            <tbody>
                                ...
                                <tr bgcolor="{{ $tr_color_class }}">
                                    ...
                                    <td>{{$key+1}}</td>
                                    <td>@if(!$order->order_confirm_id) panding#{{ $order->id }}

                                        @else{{$order->order_confirm_id}}
                                        @endif</td>

                                    <td  style="">{{$order->address??'NA'}}</td>
                                    ...
                                    <td>@if(!$order->order_confirm_id)
                                        ...
                                        @endif</td>
                                    <td>
                                    <button type="button" onClick="showItems(this)" class="btn btn-info btn-sm" data-items="{{$order->orderTransactions->toJson()}}">
