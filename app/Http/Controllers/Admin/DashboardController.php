...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $orders = $orders->with(["orderTransactions.product", "coupon"])->with('orderTransactions.product.productPackage.packageMaster')->where('status', '!=', 4)->orderBy('id', 'DESC')->paginate(10);
